...
cp p10k-with-clock.omp.json > ~/p10k-with-clock.omp.json
cp p10k-without-clock.omp.json > ~/p10k-without-clock.omp.json
cp switch-p10k-clock.ps1 > ~/switch-p10k-clock.ps1
